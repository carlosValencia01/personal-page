...
export const AboutMe = () => {
    ...
    return (
        <div className='about__body'>
            {/* Navbar */}
            <header className="aboutme-navbar">
                <div className="aboutme-navbar-container">
                    <div className='aboutme-navbar-home'>
                        <Tooltip text='Home' position='down'>
                            <a href="/">
                                <svg width='28px' viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier"> 
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8 0L0 6V8H1V15H4V10H7V15H15V8H16V6L14 4.5V1H11V2.25L8 0ZM9 10H12V13H9V10Z" fill="#1f2937ea"></path> </g></svg>
                            </a>
                        </Tooltip>
