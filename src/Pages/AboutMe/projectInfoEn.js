export const projectsEn = [
    ...
    {
        id:2,
        name:'Full Stack Developer (MEAN)',
        duration:'October 2020 - February 2021',
        compani:'Instituto Tecnologico De Tepic',
        description:`I participated in the design and development of a web platform for managing student social services, using the MEAN stack (MongoDB, Express.js, Angular, Node.js).
        The system allows students to register, view, and track their projects, while administrators can validate information, generate reports, and maintain communication with users. I implemented JWT authentication, RESTful architecture, and responsive design, improving the institution's administrative efficiency.`,
    ...
    },
    {
        ...
        description:`I collaborated on the development of an internal web platform for managing users, roles, and customized features for CENAM staff. Using .NET MVC, I designed clean and secure interfaces, along with optimized database structures for rapid query and scalability.
        The system included role-based authentication, permission management, and modules tailored to the specific needs of different technical areas. This solution contributed to more organized, secure, and centralized information management.`,
